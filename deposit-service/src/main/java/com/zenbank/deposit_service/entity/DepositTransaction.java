...
public class DepositTransaction {
	...
	private List<DepositAudit> depositAudits;
	// added this for relationship for two entities
	
	public List<DepositAudit> getDepositAudits() {
	    return depositAudits;
	}

	public void setDepositAudits(List<DepositAudit> depositAudits) {
	    this.depositAudits = depositAudits;
	}
	
	// getter setter add for above
