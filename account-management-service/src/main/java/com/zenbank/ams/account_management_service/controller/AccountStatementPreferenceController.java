...
public class AccountStatementPreferenceController {
    ...
    public ResponseEntity<StatementPreferenceResponse> createStatementPreference(
            @PathVariable Long accountId,
            @Valid @RequestBody CreateStatementPreferenceRequest requestDto) {

        StatementPreferenceResponse response =
                statementPreferenceService.createStatementPreference(accountId, requestDto);
